...
import { CreditCard, MessageSquare, Save, Wallet } from "lucide-react";
    ...
    async function cargarConfiguracion() {
      try {
        ...
        if (snapshot.exists()) {
          ...
          if (data.pagosConfig) {
            setConfig((prev) => ({ ...prev, ...data.pagosConfig }));
          }
        }
      } catch (err) {
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 dark:text-zinc-400">
                  Los clientes reservan o piden y se les abre el chat con el detalle para coordinar el pago.
                </p>
              </div>
            </div>
            <input
          ...
          <div className="flex items-center justify-between gap-4 border-b border-slate-200 pb-4 dark:border-zinc-800">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 dark:text-zinc-400">
                  Permití que tus clientes abonen al instante con su cuenta o tarjeta.
                </p>
              </div>
            </div>
            <input
          ...
          <div className="flex items-center justify-between gap-4 border-b border-slate-200 pb-4 dark:border-zinc-800">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 dark:text-zinc-400">
                  Mostrá los datos de tu cuenta bancaria para recibir transferencias directas.
                </p>
              </div>
            </div>
            <input
