    ...
    async function cargarDisponibilidad() {
      ...
      try {
        ...
        const respuesta = await fetch(
          `/api/public/appointments?${parametros.toString()}`,
          {
            method: "GET",
            cache: "no-store",
          },
        ...
        const resultado =
          (await respuesta.json()) as DisponibilidadResponse;
  ...
  async function reservar(
    ...
    try {
      ...
      if (!respuesta.ok) {
        ...
        /*
         * Si otro cliente tomó el horario
         * justo antes, actualizamos la lista.
         */
      ...
      /*
       * Volvemos a consultar para sacar
       * inmediatamente el horario reservado.
       */
      setRefrescarDisponibilidad(
        (actual) => actual + 1,
      );
      ...
      setError(
        "No se pudo conectar con el sistema de turnos.",
      );
    } finally {
      setEnviando(false);
    }
          ...
          <div className="flex items-start gap-3 rounded-xl border border-emerald-500/20 bg-emerald-500/10 p-4 text-sm text-emerald-300 sm:col-span-2">
            ...
            <div>
              ...
              <p className="mt-2 text-xs text-emerald-400/80">
                El negocio podrá confirmar tu turno desde
                su agenda.
              </p>
            </div>
          </div>
